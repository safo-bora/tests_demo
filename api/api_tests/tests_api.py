...
class TestTrelloAPI:
    ...
    def test_get_board(self):
        ...
        self.trello_api.update_board(BOARD_ID, board_name)
        board = self.trello_api.get_board(BOARD_ID)
    ...
    def test_update_board_name(self):
        ...
        updated_board_info = self.trello_api.update_board(BOARD_ID, new_name)
        assert updated_board_info['name'] == new_name, f"Board name was not updated to '{new_name}'"

    def test_delete_card(self):
        # Delete the card
        deleted_card_info = self.trello_api.delete_card(self.card_id)
        ...
        updated_cards = self.trello_api.fetch_lists(BOARD_ID)
