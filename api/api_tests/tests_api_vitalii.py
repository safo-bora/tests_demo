...
class TestTrelloAPI:
    ...
    def test_get_membership_of_board(self):
        memberships = self.board_api.get_membership_of_board(BOARD_ID)
    ...
    def test_delete_label(self):
        ...
        labels_before = self.board_api.get_label_on_board(BOARD_ID)

        self.label_api.delete_label(label_id)
        labels_after = self.board_api.get_label_on_board(BOARD_ID)
